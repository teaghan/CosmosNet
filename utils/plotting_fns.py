...
def plot_progress2(losses, y_lims=[(0,1)], x_lim=None, lp=False,
                  fontsize=18, savename=None):
    ...
    ax1.set_title('MAE Training Losses', fontsize=fontsize)
    ax1.plot(losses['batch_iters'], losses['train_mae_loss'],
                 label=r'Train', c='k')
    ax1.plot(losses['batch_iters'], losses['val_mae_loss'],
                 label=r'Val', c='r')
    ax1.set_ylabel('Loss',fontsize=fontsize)
    ...
    ax2.set_title('Latent Training Losses', fontsize=fontsize)
    ax2.plot(losses['batch_iters'], losses['train_latent_loss'],
                 label=r'Train', c='k')
    ax2.plot(losses['batch_iters'], losses['val_latent_loss'],
                 label=r'Val', c='r')
    ...
    ax3.set_title('Uniformity Training Losses', fontsize=fontsize)
    ax3.plot(losses['batch_iters'], losses['train_unif_loss'],
                 label=r'Train', c='k')
    ax3.plot(losses['batch_iters'], losses['val_unif_loss'],
                 label=r'Val', c='r')
...
def plot_progress3(losses, y_lims=[(0,.1),(0,0.1),(0,0.1)], x_lim=None,
                  fontsize=18, savename=None):
    ...
    ax1.set_title('MIM Progress', fontsize=fontsize)
    ax1.plot(losses['batch_iters'], losses['mim_train_loss'],
                 label=r'Train', c='k')
    ax1.plot(losses['batch_iters'], losses['mim_val_loss'],
                 label=r'Val', c='r')
    ax1.set_ylabel('Loss',fontsize=fontsize)

    ax2.set_title('Supervised Progress', fontsize=fontsize)
    ax2.plot(losses['batch_iters'], losses['sup_train_loss'],
                 label=r'Train', c='k')
    ax2.plot(losses['batch_iters'], losses['sup_val_loss'],
                 label=r'Val', c='r')
    ax2.set_ylabel('Loss',fontsize=fontsize)

    if 'sup_train_acc' in losses.keys():
        y_lab = 'Accuracy'
        key = 'acc'
    else:
        y_lab = 'MAE'
        key = 'mae'
    ax3.set_title('Supervised Metric', fontsize=fontsize)
    ax3.plot(losses['batch_iters'], losses[f'sup_train_{key}'],
                 label=r'Train', c='k')
    ax3.plot(losses['batch_iters'], losses[f'sup_val_{key}'],
                 label=r'Val', c='r')
    ax3.set_ylabel(y_lab, fontsize=fontsize)
